describe("Listagem das Campanhas", () => {
  ...
  it("usuário não-autenticado deve ver a página com as Campanhas da plataforma", () => {
    cy.get('[id="root"]')
  ...
  it("usuário não-autenticado deve ver todas as Campanhas cadastradas na plataforma", () => {
